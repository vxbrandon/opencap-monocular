...
def apply_distortion(points2d, k, p=None):
    ...
    r2 = x**2 + y**2
    # Clamp r2 to prevent the distortion polynomial from overflowing when
    # the initial camera projection is far off (e.g. bad extrinsics guess).
    r2 = torch.clamp(r2, max=4.0)
    r4 = r2**2
    r6 = r2 * r4
    # Radial distortion
