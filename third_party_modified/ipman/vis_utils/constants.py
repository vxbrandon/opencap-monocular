...
ipman_dir = os.path.abspath(os.path.join(os.path.dirname(__file__), "../"))

ESSENTIALS_DIR = os.path.join(ipman_dir, "data/essentials")
SMPLX_VERT_SEG = os.path.join(
    ipman_dir, "data/meshscripts/smplx_vert_segmentation.json"
)
SMPL_VERT_SEG = os.path.join(ipman_dir, "data/meshscripts/smpl_vert_segmentation.json")
SEGMENTS_DIR = os.path.join(ipman_dir, "data/essentials/yogi_segments")
